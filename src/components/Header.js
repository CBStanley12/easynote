...
const Header = ({ togglePreview, deleteNote, isPreviewDisplayed }) => {
    return (
        <header className="layout-header header">
            <button className="btn btn-icon btn--left" onClick={toggleSidebar} aria-label="Toggle Sidebar">
            ...
            <div>
                <button className="btn btn-icon btn--right" onClick={togglePreview} aria-label="Toggle Preview">
                    {
                        isPreviewDisplayed ?
                ...
                <button className="btn btn-icon btn--right header-icon" onClick={deleteNote} aria-label="Delete">
