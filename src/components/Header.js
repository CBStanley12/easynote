...
const Header = ({ togglePreview, deleteNote, isPreviewDisplayed }) => {
    return (
        <header className="layout-header header">
            <button className="icon icon-left" onClick={toggleSidebar} aria-label="Toggle Sidebar">
            ...
            <div>
                <button className="icon icon-space icon-right" onClick={togglePreview} aria-label="Toggle Preview">
                    {
                        isPreviewDisplayed ?
                ...
                <button className="icon icon-right" onClick={deleteNote} aria-label="Delete">
