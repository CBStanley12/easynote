    ...
    return (
        <div className="layout-menu menu" data-display={isMenuDisplayed ? "is-active" : "is-hidden"}>
            ...
            <footer className="menu_section menu_section--center">
                <small className="menu_section-copyright">&copy; 2019 <a className="menu-link" aria-label="External Link" href="https://cbstanley.dev" target="_blank" rel="noopener noreferrer">Christopher Stanley</a></small>
            </footer>
        </div>
    )
}
